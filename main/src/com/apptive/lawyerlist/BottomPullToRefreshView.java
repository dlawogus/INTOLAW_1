...
import com.apptive.lawyerlist.PropertyAnimation.PropertyListener;
...
public class BottomPullToRefreshView extends LinearLayout {
	...
	private void init() {
		...
		scrollView = (ScrollView)headerLayout.findViewById(R.id.scrollView_refresh);
		scrollMainLayout = (LinearLayout)scrollView.findViewById(R.id.linearLayout_scrollMain);
		headerLayout.setVisibility(View.GONE);
		
		imageView = (ImageView)headerLayout.findViewById(R.id.arrow);
