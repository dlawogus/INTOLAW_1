...
public class BaseExpandableAdapter extends BaseExpandableListAdapter{
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if(v == null){
			...
			v = inflater.inflate(R.layout.expandable_list_item_group, parent, false);
		...
		if(isExpanded){
			viewHolder.iv_image.setBackgroundResource(R.drawable.img2);
		}else{
			viewHolder.iv_image.setBackgroundResource(R.drawable.img1);
		}
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if(v == null){
			viewHolder = new ViewHolder();
			v = inflater.inflate(R.layout.expandable_list_item_child, null);
			Utilities.setGlobalFont(v, con); 
